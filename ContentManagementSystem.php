...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $loginData = include('login-data.php');
                        ...
                        <div class="breaking-news">
                            <div id="breakingNewsTicker" class="ticker">
                                <ul>
                                    ...
                                    <li><a href="#">Culinary Cartel 'til We Bite</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="deliciousNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                            <ul>
                                <li class="active"><a href="ContentManagementSystem.php">Home</a></li>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                                ...
                                <a href="availRecipes.php" class="btn delicious-btn" data-animation="fadeInUp" data-delay="1000ms">See More Receipes</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-catagory">
                        ...
                        <div class="top-cta-content">
                            ...
                            <a href="availRecipes.php" class="btn delicious-btn">See More Recipes</a>
                        </div>
                    </div>
                </div>
                <!-- Top Catagory Area -->
                <div class="col-12 col-lg-6">
                    <div class="single-top-catagory">
                        ...
                        <div class="top-cta-content">
                            ...
                            <h6>Simple &amp; Delicios</h6>
                            <a href="availRecipes.php" class="btn delicious-btn">See More Receipes</a>
                        </div>
                    </div>
                </div>
            </div>

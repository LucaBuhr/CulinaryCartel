...
<body>
    ...
    <div class="container">
        <br></br>
        <?php
        $recipeData = json_decode(file_get_contents('recipes.json'), true);

        if ($recipeData) {
            foreach ($recipeData as $recipe) {
                echo "<div class='recipe-card'>";
                echo "<h2>" . $recipe['recipe_title'] . "</h2>";
                echo "<p>" . $recipe['recipe_description'] . "</p>";
                echo "<p>Cooking Time: " . $recipe['time_to_cook'] . "</p>";
                echo "<p>Ingredients: " . $recipe['ingredients'] . "</p>";
                echo "<p>Directions: " . $recipe['directions'] . "</p>";
                echo "</div>";
            }
        } else {
            echo "Error reading recipes data.";
        }
        ?>
    </div>

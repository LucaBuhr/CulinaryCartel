...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $userPage = "user_pages/user_" . $username . ".php";
                        ...
                        <div class="classy-menu">
                            ...
                            <ul>
                                ...
                                <li><a href="../common_resources/user_profile.php">User Profile</a></li>
                                        ...
                                        <li class="active"><a href="../common_resources/login.php">Login</a></li>
                                        <?php
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <section class="login-area section-padding-80">
        <div class="container">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            ...
                            <form action="login.php" method="post">
                                ...
                                <button type="submit" class="btn delicious-btn w-100">Log In</button>
                            </form>
                        </div>
                    </div>
                </div>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($insertUserQuery) === TRUE) {
            $userPageTemplate = file_get_contents('user_template.php');
            $userPageContent = str_replace('{{USERNAME}}', $username, $userPageTemplate);

            $userPageFilename = "user_pages/user_$username.php";
